// Adapted from DavidHDev/react-bits (DecryptedText, TS-CSS).
// Upstream b6666e9f3a03a062143ce409f3aac53e27fdfaa8; license in ./LICENSE.md.
// Local adaptations: reduced-motion support and stable screen-reader text.
...
export default function DecryptedText({
  ...
  const reduceMotion = useSyncExternalStore(subscribeReducedMotion, readReducedMotion, () => true);
  ...
  /* View Observer */
  useEffect(() => {
    if (reduceMotion || (animateOn !== 'view' && animateOn !== 'inViewHover')) return;
  ...
  if (reduceMotion) return <span className={parentClassName}>{text}</span>;
